...
if (amountCompanyBlock.length > 6) {
  document.querySelector(".companies-wrapper").style.overflow = "scroll"
} else {
   document.querySelector(".companies-wrapper").style.overflow = "hidden"
}
